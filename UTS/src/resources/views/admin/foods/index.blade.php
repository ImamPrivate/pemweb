...
@can('food_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.foods.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.food.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.food.title_singular') }} {{ trans('global.list') }}
    </div>
...
@can('food_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.foods.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.foods.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'foodname', name: 'foodname' },
{ data: 'customernote', name: 'customernote' },
